...
module.exports.run = async (bot, message, args) => {
    ...
    // käsittelemällä base64 -> uft8 saadaan kaikki merkit näkymään oikein
    let response = await fetch(`https://opentdb.com/api.php?amount=1&difficulty=medium&type=multiple&encode=base64`); 
