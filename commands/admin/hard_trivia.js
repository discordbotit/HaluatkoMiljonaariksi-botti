...
module.exports.run = async (bot, message, args) => {
    ...
    let response = await fetch(`https://opentdb.com/api.php?amount=1&difficulty=hard&type=multiple&encode=base64`) //HUOM. linkit base64 encodella, koska defaultilla esim. heittomerkit näkyy json-tiedostossa "&quot;", käsittelemällä base64 -> uft8 tämä saadaan kaikki merkit näkymään oikein
