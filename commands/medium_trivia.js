...
var fetch = require('node-fetch'); //Node-fetch moduuli mukaan
...
const Data = require("../models/medium_questions.js"); //Viitataan malliin users.js
...
module.exports.run = async (bot, message, args) => {
    ...
    let response = await fetch(`https://opentdb.com/api.php?amount=1&difficulty=medium&type=multiple&encode=base64`) //HUOM. linkit base64 encodella, koska defaultilla esim. heittomerkit näkyy json-tiedostossa "&quot;", käsittelemällä base64 -> uft8 tämä saadaan kaikki merkit näkymään oikein
